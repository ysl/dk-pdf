...
class Settings {
	...
	public function dkpdf_support_screen() { ?>
		...
		<div class="wrap">
			...
			<div class="dkpdf-item">
				...
				<p><a href="http://wp.dinamiko.com/demos/dkpdf/documentation/" target="_blank">Go to Documentation</a>
				</p>
			</div>
	...
	public function add_settings_link( $links ) {
		...
		$settings_link = '<a href="admin.php?page=' . 'dkpdf_settings">' . __( 'Settings', 'dkpdf' ) . '</a>';
