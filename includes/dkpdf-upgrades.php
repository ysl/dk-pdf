...
{
    add_dashboard_page('DK PDF Welcome', 'DK PDF Welcome', 'manage_options', 'dkpdf-welcome',
        'dkpdf_welcome_page');
}
...
{ ?>
    ...
    <div class="wrap">
        ...
        <ul>
            ...
            <li>
                <h3 style="margin-top:20px;">PDF Setup tab for adjusting page orientation, font size
                    and margins of the PDF</h3>
                <?php
            ...
            <li>
                <h3 style="margin-top:20px;">[dkpdf-remove] shortcode for removing pieces of content
                    in the generated PDF</h3></li>
            <p><a href="http://wp.dinamiko.com/demos/dkpdf/doc/dkpdf-remove-shortcode/"
                  target="_blank">See more info here</a></p>
        </ul>
