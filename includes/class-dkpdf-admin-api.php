...
class DKPDF_Admin_API
{
    ...
    public function add_meta_box(
        ...
        foreach ($post_types as $post_type) {
            add_meta_box($id, $title, array($this, 'meta_box_content'), $post_type, $context,
    ...
    public function display_meta_box_field($field = array(), $post)
    {
        ...
        $field = '<p class="form-field"><label for="' . $field['id'] . '">' . $field['label'] . '</label>' . $this->display_field($field,
                $post, false) . '</p>' . "\n";
