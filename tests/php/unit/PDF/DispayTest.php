...
class Display_Test extends TestCase {
	...
	public function test_removeButton_true() {
		...
		$this->assertTrue( $display->removeButton() );
	}

	public function test_removeButton_false() {
		...
		$this->assertFalse( $display->removeButton() );
	}
}
